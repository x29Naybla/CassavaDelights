package com.x29naybla.cassavadelights;
...
@Mod(CassavaDelights.MOD_ID)
public class CassavaDelights
{
    public static final String MOD_ID = "cassavadelights";
    private static final Logger LOGGER = LogUtils.getLogger();

    public CassavaDelights() {
